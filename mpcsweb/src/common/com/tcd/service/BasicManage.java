...
@Transactional
@Component
public class BasicManage<T extends HibernateDao, E> {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public Page<E> findPage(final Page<E> page, final List<PropertyFilter> filters, final Criterion... criterions) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public Page<E> findPage(final Page<E> page, final CriteriaParam criteriaParam, final List<PropertyFilter> filters) {
