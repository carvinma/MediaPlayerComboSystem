...
public class ChineseUtils {
	...
	public static boolean isEnChar(char c){
		...
		return s==null? true:(s.length()==s.getBytes().length);
	}
	...
	public static String substr(String str,Integer len){
		...
		if(str==null || len==0 || str.length()==0){
			return "";
		}
		...
		for(int i=0;(len>slen && i<len && i<cs.length) ;i++){
			s.append(cs[i]);
			if(!ChineseUtils.isEnChar(cs[i])){				
				slen+=2;
			}else{
				slen++; 
			}
	...
	public static void main(String[] args) {
		String str = null;
		str = "a";
		System.out.println("Spell=" + ChineseUtils.substr(str,40));

//		str = "张牙舞爪》。，";
//		System.out.println("Spell=" + ChineseUtils.getFullSpell(str));
//
//		str = "李鹏，可耻下场。";
//		System.out.println("Spell=" + ChineseUtils.getFullSpell(str));
//
